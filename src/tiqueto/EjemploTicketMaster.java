...
public class EjemploTicketMaster {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Asigno los valores de las entradas de reposicion y el total a las variables de la clase webCompra
		webCompra.entradasreposicion = REPOSICION_ENTRADAS;
		webCompra.entradastotales = TOTAL_ENTRADAS;
